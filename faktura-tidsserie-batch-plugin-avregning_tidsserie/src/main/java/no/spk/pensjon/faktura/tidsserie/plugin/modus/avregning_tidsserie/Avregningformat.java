...
public class Avregningformat implements CSVFormat {
    ...
    private final ThreadLocal<FormatSpesifikasjon> s = ThreadLocal.withInitial(() -> new FormatSpesifikasjon(desimaltall) {
        protected void definer() {
            ...
            kolonne(72, "BEL_PEN_PREMIE_MEDL", (u, up) -> premie(up.beregn(PENPremieRegel.class).medlem()));
            kolonne(73, "BEL_PEN_PREMIE_ARBGIV", (u, up) -> premie(up.beregn(PENPremieRegel.class).arbeidsgiver()));
            kolonne(74, "BEL_PEN_PREMIE_ADM_GEB", (u, up) -> premie(up.beregn(PENPremieRegel.class).administrasjonsgebyr()));
            kolonne(75, "BEL_AFP_PREMIE_MEDL", (u, up) -> premie(up.beregn(AFPPremieRegel.class).medlem()));
            kolonne(76, "BEL_AFP_PREMIE_ARBGIV", (u, up) -> premie(up.beregn(AFPPremieRegel.class).arbeidsgiver()));
            kolonne(77, "BEL_AFP_PREMIE_ADM_GEB", (u, up) -> premie(up.beregn(AFPPremieRegel.class).administrasjonsgebyr()));
            kolonne(78, "BEL_TIP_PREMIE_MEDL", (u, up) -> premie(up.beregn(TIPPremieRegel.class).medlem()));
            kolonne(79, "BEL_TIP_PREMIE_ARBGIV", (u, up) -> premie(up.beregn(TIPPremieRegel.class).arbeidsgiver()));
            kolonne(80, "BEL_TIP_PREMIE_ADM_GEB", (u, up) -> premie(up.beregn(TIPPremieRegel.class).administrasjonsgebyr()));
            kolonne(81, "BEL_GRU_PREMIE_MEDL", (u, up) -> premie(up.beregn(GRUPremieRegel.class).medlem()));
            kolonne(82, "BEL_GRU_PREMIE_ARBGIV", (u, up) -> premie(up.beregn(GRUPremieRegel.class).arbeidsgiver()));
