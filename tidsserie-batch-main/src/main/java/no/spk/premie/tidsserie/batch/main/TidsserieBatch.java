...
import static no.spk.premie.tidsserie.batch.core.TidsserieGenerertCallback2.Metadata;
import static no.spk.premie.tidsserie.batch.core.TidsserieGenerertCallback2.metadata;
import static no.spk.premie.tidsserie.batch.core.registry.ExtensionpointStatus.merge;
...
import no.spk.premie.tidsserie.batch.main.spi.ExitCommand;
...
public class TidsserieBatch {
    ...
    private final Extensionpoint<TidsserieGenerertCallback> generertOld;
