...
import no.spk.premie.tidsserie.batch.main.ApplicationController;
...
class InMemoryBatchRunner implements TidsserieBatch {
    ...
    private final no.spk.premie.tidsserie.batch.main.TidsserieBatch batch;

    private int exitCode;

    InMemoryBatchRunner(final ServiceRegistry registry) {
        this.batch = new no.spk.premie.tidsserie.batch.main.TidsserieBatch(
                registry,
