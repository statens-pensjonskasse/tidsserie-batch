...
import no.spk.premie.tidsserie.batch.main.ConsoleView;
import no.spk.premie.tidsserie.batch.main.View;
 ...
 * CSV-outputen som ein modus i tidsserie-batch genererer.
 * <br>
...
public class EndeTilEndeModusDefinisjon implements No {
    private final Map<String, Function<ServiceRegistry, TidsserieBatch>> runas = new HashMap<>();
    ...
    private Optional<Function<ServiceRegistry, TidsserieBatch>> batch = empty();
