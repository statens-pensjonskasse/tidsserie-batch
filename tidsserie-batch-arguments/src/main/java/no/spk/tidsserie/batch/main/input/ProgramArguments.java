...
import static no.spk.tidsserie.batch.core.kommandolinje.AldersgrenseForSlettingAvLogKatalogar.aldersgrenseForSlettingAvLogKatalogar;
...
import no.spk.tidsserie.input.ArgumentSummary;
import no.spk.tidsserie.input.Arguments;
import no.spk.tidsserie.input.DurationUtil;
import no.spk.tidsserie.input.DurationValidator;
import no.spk.tidsserie.input.IntegerValidator;
import no.spk.tidsserie.input.LocalTimeConverter;
import no.spk.tidsserie.input.LocalTimeValidator;
import no.spk.tidsserie.input.PathStringValidator;
import no.spk.tidsserie.input.PrintbareProgramargumenter;
import no.spk.tidsserie.input.ReadablePathValidator;
import no.spk.tidsserie.input.WritableDirectoryValidator;
